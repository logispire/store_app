  ...
  Future<Response> postMultipartData(
    ...
    try {
      ...
      for (MultipartBody multipart in multipartBody) {
        if (multipart.file != null || multipart.otherFile != null) {
          if (foundation.kIsWeb) {
            ...
            if (multipart.file != null) {
              path = multipart.file!.path;
            } else if (multipart.otherFile != null) {
              path = multipart.otherFile!.files.first.path!;
            }
            if (path.isNotEmpty) {
              File file = File(path);
...
class MultipartBody {
  ...
  MultipartBody(this.key, this.file, {this.otherFile});
}
