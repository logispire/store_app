...
class AuthRepo {
  ...
  Future<Response> registerRestaurant(StoreBody store, XFile? logo,
      XFile? cover, FilePickerResult? certificate) async {
    return apiClient.postMultipartData(
      ...
      [
        ...
        MultipartBody('certificate', null, otherFile: certificate),
      ],
    );
  }
  ...
  Future<Response> getModules(int? zoneId) async {
    return await apiClient
        .getData('${AppConstants.modulesUri}?zone_id=$zoneId');
  }
