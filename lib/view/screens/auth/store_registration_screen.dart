...
import 'package:sixam_mart_store/view/screens/auth/widget/custom_time_picker.dart';
import 'package:sixam_mart_store/view/screens/auth/widget/pass_view.dart';
import 'package:sixam_mart_store/view/screens/auth/widget/select_location_module_view.dart';
                ...
                Visibility(
                  ...
                  child: Column(children: [
                    ...
                    Align(
                      ...
                      child: Stack(children: [
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              height: 120,
                              alignment: Alignment.center,
                              child: authController.pickedCertificate != null
                                  ? Text(authController
                                          .pickedCertificate?.names.first ??
                                      "-")
                                  : Column(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                        ...
                        Positioned(
                          ...
                          child: InkWell(
                            onTap: () =>
                                authController.pickFileForCertificate(),
                            child: DottedBorder(
                              color: Theme.of(context).primaryColor,
                              strokeWidth: 1,
                              strokeCap: StrokeCap.butt,
                    ...
                    authController.zoneList != null
                        ? const SelectLocationAndModuleView(fromView: true)
                      ...
                      if (fName.isEmpty) {
                        ...
                        authController.registerStore(StoreBody(
                          ...
                          moduleId: authController
                              .moduleList![authController.selectedModuleIndex!]
                              .id
                              .toString(),
                          deliveryTimeType: authController.deliveryTimeTypeList[
