...
class AddItemScreen extends StatefulWidget {
  ...
  const AddItemScreen(
      {Key? key, required this.item, required this.translations})
      : super(key: key);
...
class _AddItemScreenState extends State<AddItemScreen> {
  ...
  bool isGrocery =
      Get.find<AuthController>().profileModel!.stores![0].module!.moduleType ==
          'grocery';
  ...
  void initState() {
    ...
    if (_update) {
      ...
      if (isGrocery) {
        Get.find<StoreController>().setOrganic(_item.organicStatus == 1);
      }
      ...
      body: SafeArea(
        child: GetBuilder<StoreController>(builder: (storeController) {
          ...
          if (storeController.unitList != null) {
            for (int index = 0;
                index < storeController.unitList!.length;
                index++) {
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            Expanded(
                                child: CustomDropDown(
                              value:
                                  storeController.subCategoryIndex.toString(),
                                ...
                                storeController.tagList.isNotEmpty
                                    ? SizedBox(
                                        ...
                                        child: ListView.builder(
                                            ...
                                            itemCount:
                                                storeController.tagList.length,
                          ...
                          _module!.addOn!
                              ? SizedBox(
                                  height:
                                      storeController.selectedAddons!.isNotEmpty
                                          ? 40
                                          : 0,
                                  child: ListView.builder(
                                    itemCount:
                              ...
                              ? Row(children: [
                                  ...
                                  FlutterSwitch(
                                    ...
                                    onToggle: (bool isActive) {
                                      storeController.setOrganic(isActive,
                                          canUpdate: true);
                                    },
                                  ),
                                ])
                                ...
                                ClipRRect(
                                  ...
                                  child: storeController.rawLogo != null
                                      ...
                                      : FadeInImage.assetNetwork(
                                          ...
                                          image:
                                              '${Get.find<SplashController>().configModel!.baseUrls!.itemImageUrl}/${_item.image ?? ''}',
                                          height: 120,
                                          width: 150,
                                          fit: BoxFit.cover,
                          ...
                          onPressed: () {
                            ...
                            if (price.isEmpty) {
                              ...
                              if (Get.find<SplashController>()
                                ...
                                for (VariationModelBody variation
                                    in storeController.variationList!) {
                                  ...
                                  _item.foodVariations!.add(FoodVariation(
                                    ...
                                    type:
                                        variation.isSingle ? 'single' : 'multi',
