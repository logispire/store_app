  ...
  Widget build(BuildContext context) {
    return GetBuilder<StoreController>(builder: (storeController) {
      return GetBuilder<AuthController>(builder: (authController) {
        Store? store = authController.profileModel != null
            ? authController.profileModel!.stores![0]
            : null;

        return Scaffold(
          backgroundColor: Theme.of(context).cardColor,
          floatingActionButton: storeController.tabIndex == 0 &&
                  Get.find<AuthController>().modulePermission!.item!
